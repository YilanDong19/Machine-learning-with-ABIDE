...
class OptInit():
    def __init__(self):
        ...
        parser.add_argument('--hgc_2', type=int, default=64, help='hidden units of gconv layer')
        parser.add_argument('--hgc_3', type=int, default=128, help='hidden units of gconv layer')
