...
root_folder = 'Input your own path (example: D:\EV_GCN\data   should be the same with the root_folder in fetch_data.py)'
...
def get_networks(subject_list, kind, atlas_name="cc200", variable='connectivity'):
    """
        subject_list : list of subject IDs
        kind         : the kind of connectivity to be used, e.g. lasso, partial correlation, correlation
        atlas_name   : name of the parcellation atlas used
